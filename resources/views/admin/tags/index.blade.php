                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$tag->id}}</td>
                      <td>{{$tag->title}}</td>
                      <td class="text-center"><a href="{{route('admin.tag.show', $tag->id)}}"><i class="far fa-solid fa-eye"></i></a></t>
                      <td class="text-center"><a href="{{route('admin.tag.edit', $tag->id)}}" class="text-success"><i class="fas fa-solid fa-pen"></i></a></td>
